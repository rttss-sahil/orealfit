...
export const TermsAndCondiitons = ({ state }) => {
  return (
    <div className="terms-and-conditions-page">
      ...
      <div>
        ...
        <br />
        <br />
        This website is operated by Orealfit. Throughout the site, the terms
        “we”, “us” and “our” refer to Orealfit. Orealfit offers this website,
        ...
        <br />
        <strong>
          SECTION 6 – ACCURACY OF BILLING AND ACCOUNT <br />
          <br />
          INFORMATION
        </strong>
        ...
        <br />
        <strong>
          SECTION 9 – USER COMMENTS, FEEDBACK AND OTHER <br />
          <br />
          SUBMISSIONS
        </strong>
        ...
        shall Orealfit, our directors, officers, employees, affiliates, agents,
        ...
        <br />
        <br />
        You agree to indemnify, defend and hold harmless OrealFit and our
...
export default connect(mapStateToProps)(TermsAndCondiitons);
